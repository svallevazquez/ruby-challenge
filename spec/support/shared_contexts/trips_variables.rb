...
shared_context "trips variables" do
  ...
  let(:first_trip) do
    RubyChallenge::Trip.new(segments: first_segments, beginning: first_segments.first.from_time, destination: "BCN")
  end
  ...
  let(:second_trip) do
    RubyChallenge::Trip.new(segments: second_segments, beginning: second_segments.first.from_time, destination: "MAD")
  end
  ...
  let(:third_trip) do
    RubyChallenge::Trip.new(segments: third_segments, beginning: third_segments.first.from_time, destination: "NYC")
  end
